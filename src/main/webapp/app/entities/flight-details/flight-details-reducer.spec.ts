...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLIGHTDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLIGHTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLIGHTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLIGHTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLIGHTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLIGHTDETAILS actions', async () => {
      const expectedActions = [
        {

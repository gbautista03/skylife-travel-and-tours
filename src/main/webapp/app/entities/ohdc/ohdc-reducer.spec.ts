...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ohdc.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OHDC_LIST actions', async () => {
    ...
    it('dispatches FETCH_OHDC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OHDC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OHDC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OHDC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OHDC actions', async () => {
      const expectedActions = [
        {

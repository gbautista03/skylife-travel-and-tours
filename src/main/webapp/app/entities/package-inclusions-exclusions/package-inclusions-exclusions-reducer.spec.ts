...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './package-inclusions-exclusions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACKAGEINCLUSIONSEXCLUSIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PACKAGEINCLUSIONSEXCLUSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PACKAGEINCLUSIONSEXCLUSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PACKAGEINCLUSIONSEXCLUSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PACKAGEINCLUSIONSEXCLUSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PACKAGEINCLUSIONSEXCLUSIONS actions', async () => {
      const expectedActions = [
        {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACKAGETOUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_PACKAGETOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PACKAGETOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PACKAGETOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PACKAGETOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PACKAGETOUR actions', async () => {
      const expectedActions = [
        {

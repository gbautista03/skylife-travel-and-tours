...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUIREMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUIREMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUIREMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUIREMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUIREMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUIREMENTS actions', async () => {
      const expectedActions = [
        {
